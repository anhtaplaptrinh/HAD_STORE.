    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
       sqLiteDatabase.execSQL("create table NhanVien (" +
        ...
        sqLiteDatabase.execSQL("insert into DonHang values " +
                "(1,'20/09/2023','Dang doi don vi van chuyen',1,'KH01')," +
                "(2,'20/09/2023','Dang van chuyen',2,'KH01')," +
                "(3,'20/09/2023','Da goi hang',5,'KH01')," +
                "(4,'20/09/2023','Dang doi don vi van chuyen',3,'KH01')," +
                "(5,'20/09/2024','Dang van chuyen',4,'KH01')");
